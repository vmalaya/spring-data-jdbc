...
public final class PBKDF2Hasher {
  ...
  public String hash(char[] password) {
    ...
    byte[] dk = secretKey(password, salt, 1 << cost);
  ...
  public boolean checkPassword(char[] password, String token) {
    ...
    byte[] check = secretKey(password, salt, iterations);
    int zero = 0;
  ...
  private static byte[] secretKey(char[] password, byte[] salt, int iterations) {
